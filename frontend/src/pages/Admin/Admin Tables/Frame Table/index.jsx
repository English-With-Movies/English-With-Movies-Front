...
export default function FrameTable() {
    let { data: frameData, refetch, isLoading: frameIsLoading, isError, error } = useGetAllFrameQuery()
    ...
    return (
        ...
        frameIsLoading ? (
            ...
            <div className="pt-[50px] text-[var(--admin-text-color)]">
                            ...
                            <tbody>
                                {
                                    avatarData.length ? (
                                        avatarData.map((avatar, index) => (
                                            <tr key={avatar.id} className="border-b">
                    ...
                    >
                        <Box sx={{ ...style }} className="max-w-2xl mx-auto">
                            ...
                            <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                                <div>
                                    <Formik
                                        initialValues={{ id: selectedAvatar.id, name: selectedAvatar.name, imgName: null, isCustom: false }}
                                        validationSchema={validationSchema}
                                        onSubmit={async (values) => {
                                            ...
                                            editPostFormData.append("isCustom", false)
                                            try {
