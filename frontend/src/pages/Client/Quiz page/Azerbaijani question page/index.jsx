            ...
            <div className='bg-[var(--bg-color)] text-white pt-[103px]'>
                <div ref={startedRef} className='max-w-[500px] py-5 mx-auto my-0 flex gap-3 flex-col justify-center items-center relative'>
                    ...
                    <div className='bg-[#18406e] w-full flex justify-center items-center flex-col relative p-2 py-5 rounded-4'>
                        ...
                        <div className='absolute top-2 left-2 text-3xl cursor-pointer hover:text-gray-400'><FaPlus /></div>
                        <div onClick={() => speakingText(question.word.meaning)} className='absolute top-2 right-2 text-3xl cursor-pointer hover:text-blue-400'><HiSpeakerWave /></div>
                        <div className='absolute bottom-2 left-2 hidden' ref={sentenceRef}><div className='-mb-1'>{createdSentenceWithWordText?.english}</div>
                        <div>{createdSentenceWithWordText?.azerbaijani}</div></div>
                    </div>
