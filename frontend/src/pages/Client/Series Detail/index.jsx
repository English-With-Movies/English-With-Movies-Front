        ...
        <div className=" py-3 bg-[var(--bg-color)] text-white">
            <Container>
                            ...
                            Array.from({ length: 5 }).map((_, index) => (
                                <div key={index + 1}>
                                    ...
                                    <div className="level-button flex items-center justify-center">
                                        <input type="checkbox" id={`difficulty-check-${index + 1}`} checked={checkboxStates[index]} onChange={() => handleCheckboxChange(index)} />
                ...
                <div className="rounded-5">
                    <table className="w-full rounded-5">
                        <tbody className="rounded-5">
                            <tr className="bg-[var(--movies-bg)] text-xl rounded-5 text-[var(--text-color)] border-y">
                                <td className="p-3"><HiSpeakerWave /></td>
                                <td>kaçınmak, çekinmek</td>
                                <td>uii ai uii ii ai</td>
                                <td><HiSpeakerWave /></td>
                                <td><HiSpeakerWave /></td>
                            </tr>
                            <tr className="bg-[var(--movies-bg)] text-xl rounded-5 text-[var(--text-color)] border-y">
