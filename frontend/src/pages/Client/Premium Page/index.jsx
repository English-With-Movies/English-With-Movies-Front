                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 max-w-[800px] min-h-[200px] mx-auto my-4 gap-6 font-['PT_Serif']">
                            <div className="flex flex-col items-center justify-between p-2 border-4 border-[var(--movies-bg)] rounded">
                                <div className="py-3 w-full text-center text-xl font-bold bg-[var(--movies-bg)] rounded cursor-pointer border-2 border-[var(--movies-bg)] hover:bg-transparent transition-all duration-200 ease-in">
                                    AYLIQ 5.00$
                                </div>
                                <div className="py-3 w-full text-center text-xl font-bold bg-[var(--movies-bg)] rounded cursor-pointer border-2 border-[var(--movies-bg)] hover:bg-transparent transition-all duration-200 ease-in my-3">
                                    İLLİK 50.00$
                                </div>
                                <div className="py-3 w-full text-center text-xl font-bold bg-[var(--movies-bg)] rounded cursor-pointer border-2 border-[var(--movies-bg)] hover:bg-transparent transition-all duration-200 ease-in">
                                    ÖMÜRLÜK 200.00$
