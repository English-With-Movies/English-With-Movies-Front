...
import { useGetRanksForTodaysPointQuery } from "../../../redux/rtk query/Slices/rankSlice";
...
export default function TodaysPointsRanking() {
    ...
    let { data, isLoading } = useGetRanksForTodaysPointQuery(userInfo?.userId)
                        ...
                        <div className="bg-[var(--bg-color)] text-[var(--text-color)] py-2">
                            <Container>
                                <div className="max-w-[1000px] mx-auto my-0">
                                    <div className="my-5">
                                        <p className="text-center text-3xl font-['Dancing_Script']">BUGÜNÜN XAL SIRALAMASI</p>
